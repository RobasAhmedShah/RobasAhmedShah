...
<details>
<summary>$ cat syn_flood_defense.log</summary>

```bash
Project: SYN Flooding DDoS Firewall
Status: Operational
Description: Advanced IPS implementation using Wireshark & Scapy
Features:
...
<details>
<summary>$ cat proxy_server.log</summary>

```bash
Project: Network Proxy Server
Status: Active
Description: Real-time malicious website detection
Features:
- Traffic inspection
- Threat blocking
...
<details>
<summary>$ cat vuln_patch.log</summary>

```bash
Project: Vuln Patch Recommender
Status: Deployed
